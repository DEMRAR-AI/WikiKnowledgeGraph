...
def print_decompressed():
    print({zlib.decompress(key).decode("utf-8"): [zlib.decompress(x).decode("utf-8") for x in table[key]] for key in table})
...
if __name__ == '__main__':
    ...
    # to decompress and print out the pickled dictionary file
    """print_decompressed()
